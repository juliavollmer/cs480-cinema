...
<div id="shell">
  <div id="header">
    <h1 id = "logo"><a href="#">CS4280 Cinema</a></h1>
  ...
  <div id="main">
    <div id="content">
      ...
      <div class="box">
        ...
        <div class="movie">
          <div class="movie-image"> <span class="play"><span class="name">TRANSFORMERS</span></span> 
                   
                  <img src="css/images/movie7.jpg" alt="" /></a> 
